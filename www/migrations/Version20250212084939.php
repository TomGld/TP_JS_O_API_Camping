 ...
 */
final class Version20250212084939 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE price (id INT AUTO_INCREMENT NOT NULL, rental_id INT NOT NULL, season_id INT NOT NULL, price_per_night INT NOT NULL, INDEX IDX_CAC822D9A7CF2329 (rental_id), INDEX IDX_CAC822D94EC001D1 (season_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
